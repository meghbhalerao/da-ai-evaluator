...
from packages.diffusion_motion_generation.manip.vis.blender_vis_mesh_motion import (
...
class Trainer(object):
    ...
    def train(self):
        init_step = self.step
        print("Training for %d steps" % self.train_num_steps)
