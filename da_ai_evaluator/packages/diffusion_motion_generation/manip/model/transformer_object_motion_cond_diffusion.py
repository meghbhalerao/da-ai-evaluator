...
from packages.diffusion_motion_generation.manip.data.cano_traj_dataset import (
    normalize,
    quat_between,
    quat_fk_torch,
    quat_ik_torch,
)
from packages.diffusion_motion_generation.manip.inertialize.inert import (
    apply_inertialize,
)
from packages.diffusion_motion_generation.manip.lafan1.utils import (
    quat_slerp,
...
class ObjectCondGaussianDiffusion(nn.Module):
    ...
    def p_losses(
        ...
        # print("x_cond shape is", x_cond.shape)        
        # print("x_start shape is", x_start.shape)
        # print("noise shape is", noise.shape)
        # print("x shape is", x.shape)
        # print("padding mask shape is", padding_mask.shape)
        # print("padding mask is ", padding_mask.sum())
        ...
        local_joint_rot_mat = quat_ik_torch(
            global_joint_rot_mat.reshape(-1, 22, 3, 3), data_root_folder=os.path.join(self.data_root_folder, "../", "smpl_all_models" )
        )  # (BS*T) X 22 X 3 X 3
        
        _, human_jnts = quat_fk_torch(local_joint_rot_mat, curr_seq_local_jpos, data_root_folder=os.path.join(self.data_root_folder, "../", "smpl_all_models"))
